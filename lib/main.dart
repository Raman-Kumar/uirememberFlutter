...
class _MyHomePageState extends State<MyHomePage> {
  int _counter = 0;
  int _ok = 0;
  static bool defaultPage = true;
  static bool shoppingPage = false;
  var screenWidth;
  var screenHeight;
  @override
  Widget build(BuildContext context) {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  buildaFoodCard(screenHeight, screenWidth),
                    // making a Card Button to jump to new Page named Shopping page
                  Card(
                    elevation: 8.0,
                        ...
                        child: ListTile(
                          ...
                          subtitle: Row(
                            children: <Widget>[
                              ...
                              Text(" Explore a shopping sample",
...
// SHOPPING Page
    if (shoppingPage) {
      return Scaffold(
          ...
          body: Container(
            child :Text("I have made a seprate class for shopping change void main() => runApp(ShoppingApp())")
          ));
    }
  }
